...
import random
list_words=['charizard','pikachu','bulbasaur','dragonite','chikorita','magikarp','gyarados','meowth','wobbuffet','totodile','zapdos','articuno','blastoise','vaporean','kangaskhan','flareon','snorlax','venusaur']
